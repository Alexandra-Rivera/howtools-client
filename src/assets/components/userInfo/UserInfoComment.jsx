        ...
        <div className="text-white flex flex-row items-center">
           <figure className="rounded-[50%] border-2 border-cyan-500 w-[30px] h-[30px] box-border m-3 lg:w-[50px] lg:h-[50px] xl:w-[50px] xl:h-[50px] 2xl:w-[50px] 2xl:h-[50px]">
            ...
            <div>
                ...
                <figure>
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-star" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" className='w-[1rem] h-[1rem]'>
